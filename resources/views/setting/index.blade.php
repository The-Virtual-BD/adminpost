        ...
        <div class="p-4 w-full">
                        ...
                        <form action="{{route('settings.store')}}" method="POST">
                            ...
                            <div class="shadow sm:overflow-hidden sm:rounded-md">
                                <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-3 gap-6">
                                        <div class="col-span-3">
                                            <label for="jobTitle" class="block text-sm font-medium text-gray-700">Frontend site Moode</label>
                                ...
                                <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
                                    <button type="submit"
                                        class="inline-flex justify-center rounded-md border border-transparent bg-blue-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Save Settings</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="">
                ...
                <ul>
                    ...
                    <li><span class="p-4 uppercase">{{$setting->property}} :  </span><span>@if ($setting->value == 1)
Live
                    @else
Under Development
                    @endif</span></li>
